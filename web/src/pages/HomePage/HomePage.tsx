              ...
              <div className="container mx-auto flex flex-col space-y-16 px-4 py-16 text-center lg:flex-row-reverse lg:space-y-0 lg:px-8 lg:py-32 lg:text-left xl:max-w-7xl">
                ...
                <div className="lg:mr-16 lg:flex lg:w-1/2 lg:items-center lg:justify-center">
                  <div className="relative lg:w-96">
                    <div className="pattern-dots-xl absolute top-0 left-0 h-48 w-32 -translate-y-12 -translate-x-16 -rotate-3 transform text-indigo-100 md:h-96" />
                    <div className="pattern-dots-xl absolute bottom-0 right-0 h-48 w-32 translate-y-12 translate-x-16 rotate-3 transform text-indigo-100 md:h-96" />
            ...
            <div className="overflow-hidden bg-gray-100">
              <div className="container mx-auto px-4 py-16 lg:px-8 lg:py-32 xl:max-w-7xl">
                <div className="relative">
                  <div className="pattern-dots-lg absolute top-0 right-0 h-32 w-32 translate-x-12 -translate-y-16 transform text-gray-300 lg:h-48 lg:w-48" />
                  <div className="pattern-dots-lg absolute bottom-0 left-0 h-32 w-32 -translate-x-12 translate-y-16 transform text-gray-300 lg:h-48 lg:w-48" />
